...
import mina.infoxus.databinding.ActivityManageKeywordsBinding
        ...
        override fun onBindViewHolder(holder: KeywordViewHolder, position: Int) {
            ...
            holder.removeBtn.setOnClickListener {
                if (isAntiUninstallEnabled) {
                    Toast.makeText(this@ManageKeywordsActivity, "Cannot remove keywords while protection is locked", Toast.LENGTH_SHORT).show()
                } else {
