...
import mina.infoxus.databinding.ActivityUsageMetricsBinding
...
import mina.infoxus.views.CustomMarkerView
import java.io.File
...
class UsageMetricsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.shareStats.setOnClickListener {
            binding.btnDigiWelbeing.text = "Tracked Using InFoXus"
