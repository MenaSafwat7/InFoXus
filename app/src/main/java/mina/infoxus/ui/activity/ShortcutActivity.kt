...
class ShortcutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val isGeneralSettingsOn = isAccessibilityServiceEnabled(MainAccessibilityService::class.java)
        if(!isGeneralSettingsOn){
            Toast.makeText(this,"Find 'InFoXus Protection' and press enable",Toast.LENGTH_LONG).show()
            openAccessibilityServiceScreen(cls = MainAccessibilityService::class.java)
            finish()
        }
