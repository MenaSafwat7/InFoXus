...
import mina.infoxus.databinding.AppUsageItemBinding
import mina.infoxus.databinding.DialogPermissionInfoBinding
import mina.infoxus.databinding.FragmentAllAppUsageBinding
import mina.infoxus.ui.activity.FragmentActivity
import mina.infoxus.ui.activity.SelectAppsActivity
...
class AllAppsUsageFragment : Fragment() {
            ...
            popupMenu.setOnMenuItemClickListener { item ->
                when (item.itemId) {
                    ...
                    R.id.add_shortcut_usage_tracker -> {
                        ...
                        val shortcutInfo =
                            ShortcutInfoCompat.Builder(requireContext(), "infoxus_usage_tracker")
    ...
    private fun makeUsageStatsPermissoinDialog() {
        ...
        dialogBinding.desc.text =
            "InFoXus requires device usage access to monitor apps, helping you manage screen time effectively and stay focused on your goals. Rest assured, all data stays securely on your device and is never shared with anyone, ensuring your privacy is fully protected."
        ...
        dialogBinding.btnAccept.setOnClickListener {
            Toast.makeText(requireContext(), "Find 'InFoXus' and press enable", Toast.LENGTH_LONG)
                .show()
