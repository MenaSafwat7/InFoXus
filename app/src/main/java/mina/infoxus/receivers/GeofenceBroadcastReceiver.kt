...
import mina.infoxus.data.GeofenceEvent
import mina.infoxus.data.GeofenceTransition
...
class GeofenceBroadcastReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION_GEOFENCE_EVENT = "mina.infoxus.action.GEOFENCE_EVENT"
    }
    ...
    private fun notifyAppBlockerService(context: Context, event: GeofenceEvent) {
        ...
        context.sendBroadcast(Intent(MainAccessibilityService.ACTION_REFRESH_APP_BLOCKER))
    }
